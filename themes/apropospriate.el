...
(defmacro apropospriate-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
	  ...
	  (base00-1 (if (eq variant 'light) (color-lighten-name base00 3) "#171717"))
	  (base00-2 (if (eq variant 'light) (color-lighten-name base00 5) "#141414"))
	  (base00-3 (if (eq variant 'light) (color-lighten-name base00 10) "#111111"))
	  (base00+1  (if (eq variant 'light) (color-darken-name base00 2) "#2a2a2a"))
	  (base00+05 (if (eq variant 'light) (color-darken-name base00 1) "#222222"))
	  (base00+2  (if (eq variant 'light) (color-darken-name base00 8) "#383838"))
	  (base00+3  (if (eq variant 'light) (color-darken-name base00 12) "#444444"))
	  ...
	  ;; (highlight-line-color (if (eq variant 'light) base00-1 base00+05)))
     	  (highlight-line-color (if (eq variant 'light) base00-1 base00)))
     ,@body))
...
(defun create-apropospriate-theme (variant theme-name)
  ...
  (apropospriate-with-color-variables variant
    (custom-theme-set-faces
     ...
     `(line-number-current-line ((,class (:background ,base00 :foreground ,base02))))
     ...
     `(mode-line ((,class (:box (:line-width 4 :color ,base00-1 :style nil)
                           :background ,base00-1 :foreground ,base03
                           :height ,(or apropospriate-mode-line-height 1.0)))))
     `(mode-line-inactive ((,class (:box (:line-width 4 :color ,base00-1 :style nil)
                                    :background ,base00-1 :foreground ,base01
                                    :height ,(or apropospriate-mode-line-height 1.0)))))
     ...
     `(centaur-tabs-default ((t (:inherit default :foreground ,base02 :background "#0a0a0a" :box nil))))
     `(centaur-tabs-selected ((t (:foreground ,base02 :background ,base00 :box nil))))
     `(centaur-tabs-unselected ((t (:foreground ,base01 :background "#101010" :box nil))))
     ...
     `(markdown-header-face-2 ((,class (:foreground ,teal :weight bold))))
